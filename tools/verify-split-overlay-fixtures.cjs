...
console.log('Verified separate deployed dependency locks, three baseline source ranges and candidate adapter bytes and absence of prohibited credential patterns; no runtime config/archive included.');
